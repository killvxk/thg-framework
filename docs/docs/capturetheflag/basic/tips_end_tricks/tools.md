...
![MOLOCH](https://github.com/aol/moloch/wiki) 
## SECURITY ONION - Linux distro for intrusion detection, network security monitoring, and log management
![SECURITY ONION](https://security-onionsolutions.github.io/security-onion/) 
...
![The Enhanced Mitigation Experience Toolkit](https://support.microsoft.com/en-us/kb/2458544) 
## ATTACK SURFACE ANALYZER BY MICROSOFT - Baseline Tool
![ATTACK SURFACE ANALYZERATTACK SURFACE ANALYZER](https://www.microsoft.com/enus/download/confirmation.aspx?id=24487) 

## WINDOWS TO GO - USB Portable Windows 8
![WINDOWS TO GO](https://technet.microsoft.com/enus/library/hh831833.aspx) 

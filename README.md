...
| - [] show creds    |   show creds in db -> (@module_required)|
| - [] show devices  |  show devices modules -> (@module_required)|
| - [] show encoders |  show encoders for module -> (@module_required)|
| - [] show exploits |  show exploit modules -> (@sys_module)|
...
| - [] show threads  | View and manipulate background threads -> (@module_required)|
...
Command               |Description
| -------------       |:-------------: |
|- [x] *makerc*        |Save commands entered since start to a file
|- [x] *resource*      |Run the commands stored in a file

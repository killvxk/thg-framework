...
from thgconsole.core.ModulesBuild.Exploits.exploit import Exploit
from thgconsole.core.ModulesBuild.Exploits.exploit import Protocol
from thgconsole.core.CoreUtils.option import THGOptBool
from thgconsole.core.CoreUtils.printer import print_status
from thgconsole.core.CoreUtils.printer import print_error
from thgconsole.core.CoreUtils.utils import is_ipv4
from thgconsole.core.CoreUtils.utils import is_ipv6
...
class TCPClient(Exploit):
    ...
    verbosity = THGOptBool(True, "Enable verbose output: true/false")

...
# -*- coding: utf-8 -*-
"""
thgcmd documentation build configuration file, created by
...
version = get_distribution('thgcmd').version
...
latex_documents = [
    (master_doc, 'thgcmd.tex', 'thgcmd Documentation',
...
man_pages = [
    (master_doc, 'thgcmd', 'thgcmd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'thgcmd', 'thgcmd Documentation',
     author, 'thgcmd', 'A python package for building powerful command-line interpreter (CLI) programs.',
     'Miscellaneous'),
]

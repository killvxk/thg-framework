...
# coding=utf-8
"""
A sample application for thgcmd demonstrating how to use hooks.
...
class CmdLineApp(cmd2.Cmd):
    """Example thgcmd application demonstrating the use of hooks.
    ...
    def __init__(self, *args, **kwargs):
        # sneakily remove the thgcmd.Cmd command called load

...
# flake8: noqa F821
"""
This is a Python script intended to be used with the "python_scripting.py" thgcmd example application.

To run it you should do the following:
    ./python_scripting.py
    pyscript scripts/conditional.py directory_path

Note: The "app" function is defined within the thgcmd embedded Python environment and in there "self" is your thgcmd

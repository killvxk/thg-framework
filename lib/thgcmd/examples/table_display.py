...
def make_table_parser() -> cmd2.argparse_completer.ACArgumentParser:
    ...
    NOTE: The two thgcmd argparse decorators require that each parser be unique, even if they are essentially a deep copy
...
class TableDisplay(cmd2.Cmd):
    """Example thgcmd application showing how you can display tabular data."""

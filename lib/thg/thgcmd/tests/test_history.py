...
# flake8: noqa E302
"""
Test history functions of thgcmd
"""
import tempfile
import os
import sys
...
def test_existing_history_file(hist_file, capsys):
    ...
    # Create the history file before making thgcmd app
    with open(hist_file, 'w'):
        pass

    # Create a new thgcmd app
    ...
    # Unregister the call to write_history_file that thgcmd did

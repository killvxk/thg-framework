...
# Help text for base thgcmd.Cmd application
...
def complete_tester(text: str, line: str, begidx: int, endidx: int, app) -> Optional[str]:
    """
    This is a convenience function to test thgcmd.complete() since
    ...
    :param app: the thgcmd app that will run completions

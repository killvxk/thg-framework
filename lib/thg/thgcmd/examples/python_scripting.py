#!/usr/bin/env python
# coding=utf-8
"""A sample application for how Python scripting can provide conditional control flow of a thgcmd application.

thgcmd's built-in scripting capability which can be invoked via the "@" shortcut or "load" command and uses basic ASCII
...
from the previous command.  This is where the ability to run Python scripts inside a thgcmd application via the pyscript
...
class CmdLineApp(cmd2.Cmd):
    """ Example thgcmd application to showcase conditional control flow in Python scripting within thgcmd aps. """

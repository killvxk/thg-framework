...
class RemoveUnusedBuiltinCommands(cmd2.Cmd):
    """ Example thgcmd application where we remove some unused built-in commands."""
    ...
    def __init__(self):
        ...
        # To remove built-in commands entirely, delete their "do_*" function from the thgcmd.Cmd class

...
# coding=utf-8
"""
A sample application for thgcmd. Demonstrating colorized output using the plumbum package.
...
WARNING: This example requires the plumbum package, which isn't normally required by thgcmd.
"""
...
class CmdLineApp(cmd2.Cmd):
    """Example thgcmd application demonstrating colorized output."""

    # Setting this true makes it run a shell command if a thgcmd/cmd command doesn't exist

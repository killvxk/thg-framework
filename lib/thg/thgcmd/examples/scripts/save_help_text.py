...
# flake8: noqa F821
"""
A thgcmd script that saves the help text for every command, sub-command, and topic to a file.
This is meant to be run within a thgcmd session using pyscript.
"""

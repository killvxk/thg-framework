...
# coding=utf-8
"""
This is intended to be a completely bare-bones thgcmd application suitable for rapid testing and debugging.
"""
from cmd2 import cmd2

if __name__ == '__main__':
    import sys
    # If run as the main application, simply start a bare-bones thgcmd application with only built-in functionality.

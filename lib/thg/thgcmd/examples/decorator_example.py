#!/usr/bin/env python
# coding=utf-8
"""A sample application showing how to use thgcmd's argparse decorators to
process command line arguments for your application.

Thanks to thgcmd's built-in transcript testing capability, it also
...
if __name__ == '__main__':
    ...
    # Instantiate your thgcmd application
    c = CmdLineApp()

    # And run your thgcmd application
    sys.exit(c.cmdloop())

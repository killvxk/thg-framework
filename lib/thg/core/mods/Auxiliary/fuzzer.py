...
class BaseAuxiliary_Fuzzer:
    ...
    def register_Fuzzer(self, timeout_value=5, threads_value=1):
      ...
      self.register_options([
            BaseOption(name='FuzzTracer',required=True, description='Sets the magic string to embed into fuzzer string inputs', value='MSFROCKS'),
            BaseOption(name='FuzzChar',required=True, description='Sets the character to use for generating long strings', value='X')

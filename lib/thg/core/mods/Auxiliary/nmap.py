...
class BaseAuxiliary_Nmap:
  ...
  def register_Nmap(self):
    ...
    self.register_options([
        ...
        BaseOption(name='RHOSTS', required=False, description="list of hosts",value=""),
        BaseOption(name='NMAP_VERBOSE', required=False, description='Display nmap output', volue=True),
        BaseOption(name='RPORTS', required=False, description='Ports to target'), # RPORT supersedes RPORTS
    ])
